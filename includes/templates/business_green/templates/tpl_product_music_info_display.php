...
<ul id="productDetailsList" class="floatingBox back">
  ...
  <?php echo (($flag_show_product_music_info_artist == 1 and !empty($products_artist_name)) ? '<li><span class="product-info-label">' . TEXT_PRODUCT_ARTIST. '</span>' . $products_artist_name . '</li>' : '') . "\n"; ?>
  <?php echo (($flag_show_product_music_info_genre == 1 and !empty($products_music_genre_name)) ? '<li><span class="product-info-label">' . TEXT_PRODUCT_MUSIC_GENRE. '</span>' . $products_music_genre_name . '</li>' : '') . "\n"; ?>
</ul>
<br class="clearBoth" />
<?php
  }
